...
inline  fp_int add_fps(fp_int x, fp_int y)
{
...
inline fp_int sub_fps(fp_int x, fp_int y)
{
    return (fp_int){x.val - y.val};
}
...
inline fp_int mult_fps(fp_int x, fp_int y)
{
...
inline fp_int div_fps(fp_int x, fp_int y)
{
